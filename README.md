<div align="center">
  <img src="docs/assets/readme-hero.png" alt="Qguard Hero" width="100%">
  
  <p><em>Air-Gapped AI Wallet Security Auditor</em></p>
  ...
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-black.svg)](https://github.com/edycutjong/frontier-tether-qvac)
</div>
...
1. **Clone the repo:**
   ```bash
   git clone https://github.com/edycutjong/frontier-tether-qvac.git
   cd frontier-tether-qvac
   ```
